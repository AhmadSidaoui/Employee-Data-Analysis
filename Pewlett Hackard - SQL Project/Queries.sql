...
-- Grouping the number employees who are eligible for retrirement by department number
...
-- List of active managers per department
SELECT dm.dept_no,
 	d.dept_name,
 	dm.emp_no,
 	ce.last_name,
...
-- Information relevant to sales team and Development team
SELECT emp_no,
	first_name,
	last_name,
	dept_name
INTO sales_dev_teams_info
FROM dept_info
